...
def reescaler(numerical_feature): # ???
    ...
    try:
        ...
        print(Fore.GREEN + "Reescalado aplicado con éxito" + Fore.RESET)
    except Exception as e:
...
def save_model(gs):
    ...
    Parámetros: gs: objeto GridSearchCV, el cual contiene el modelo y los resultados de la búsqueda de hiperparámetros.
    Excepciones: Si ocurre algún error al guardar el modelo.
    """
    try:
...
def load_model():
    ...
    Returns: model: El modelo cargado desde el archivo 'output/modelo.pkl'.
